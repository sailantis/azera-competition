...
<h2>Stack</h2>
<ul>
    <li>Framework: <strong>CodeIgniter 4</strong></li>
    <li>Template engine: <strong>CI4 Views (PHP templates)</strong></li>
    <li>Database: <strong>SQLite</strong> (WAL mode)</li>
    <li>ORM: <strong>CodeIgniter Model</strong> (Active Record)</li>
