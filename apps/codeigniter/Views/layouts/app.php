...
<head>
    ...
    <title><?= esc($title) ?> — Azera Competition (CodeIgniter 4)</title>
    <style>
...
<body>
    ...
    <footer class="meta">
        Rendered with CodeIgniter 4 — Azera Competition Benchmark
        <?= isset($locale) ? '| Locale: ' . esc($locale) : '' ?>
        <?= isset($platform) ? '| Platform: ' . esc($platform) : '' ?>
    </footer>
</body>
