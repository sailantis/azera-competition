...
<h2>Stack</h2>
<ul>
    <li>Framework: <strong>CakePHP 5</strong></li>
    <li>Template engine: <strong>Cake View (PHP templates)</strong></li>
    <li>Database: <strong>SQLite</strong> (WAL mode)</li>
    <li>ORM: <strong>Cake ORM</strong> (Table/Entity hydration)</li>
