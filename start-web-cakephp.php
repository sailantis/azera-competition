...
/**
 * Web server starter for the CakePHP 5 benchmark app.
 *
 * Usage:
 *   php start-web-cakephp.php             # start on default port 8885
 *   php start-web-cakephp.php --port=9000 # custom port
 *   php start-web-cakephp.php --host=0.0.0.0 --port=8080
 *
 * Seeds the shared benchmark database automatically if it doesn't exist,
 * then launches PHP's built-in development server with Cake's router script.
 * Press Ctrl+C to stop.
 *
 * (Sibling starters: start-web-azera.php 8888, start-web-spiral.php 8887,
 *  start-web-codeigniter.php 8886.)
 */

// --- Args ---
$opts = getopt('', ['host::', 'port::']);
$host = $opts['host'] ?? 'localhost';
$port = (int) ($opts['port'] ?? 8885);
...
$docRoot    = $root . '/public';
$router     = $root . '/public/index-cakephp.php';
...
echo "Azera Competition — CakePHP 5 web server starting...\n";
