 ...
 *
 * Usage:
 *   php start-web-azera.php              # start on default port 8888
 *   php start-web-azera.php --port=9000  # custom port
 *   php start-web-azera.php --host=0.0.0.0 --port=8080
 *
...
echo "Azera Competition — Azera web server starting...\n";
