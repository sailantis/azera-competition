...
/**
 * Web server starter for the Laravel 12 benchmark app.
 *
 * Usage:
 *   php start-web-laravel.php             # start on default port 8884
 *   php start-web-laravel.php --port=9000 # custom port
 *   php start-web-laravel.php --host=0.0.0.0 --port=8080
 *
 * Seeds the shared benchmark database automatically if it doesn't exist,
 * then launches PHP's built-in development server with Laravel's router
...
$docRoot    = $root . '/public';
$router     = $root . '/public/index-laravel.php';
...
echo "Azera Competition — Laravel 12 web server starting...\n";
